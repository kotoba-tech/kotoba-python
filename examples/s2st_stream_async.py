"""Async streaming speech-to-speech translation.

Reads an audio file, pushes 40 ms PCM16 chunks to the server, prints
the source-language transcript live, and writes the translated audio
to a WAV file.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", default="translated.wav")
